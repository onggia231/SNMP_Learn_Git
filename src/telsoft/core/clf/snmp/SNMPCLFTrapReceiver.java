...
public class SNMPCLFTrapReceiver implements CommandResponder {
    public SNMPCLFTrapReceiver() {
    }

    public static void main(String[] args) {
        SNMPCLFTrapReceiver snmp4jTrapReceiver = new SNMPCLFTrapReceiver();
        try {
            snmp4jTrapReceiver.listen(new UdpAddress("127.0.0.1/3868"));
        } catch (IOException e) {
